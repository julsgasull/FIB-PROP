        ...
        TilePanel(final BoardPanel boardPanel, final int tileId) {
            ...
            this.setOnMouseClicked(mouseEvent -> {
                ...
                if (mouseEvent.getButton().equals(MouseButton.SECONDARY)) {
                    ...
                    if (movedPiece.getOldX() == -1) {//first click
                       ...
                       // if (humanMovedPiece == null) {
                        ...
                        if (movedPiece.getPiece().checkMove(movedPiece.getOldX(), movedPiece.getOldY(), movedPiece.getNewX(), movedPiece.getNewY(), presentacio.getMatch().getActualBoard()) && !(movedPiece.getOldX()==movedPiece.getNewX() && movedPiece.getOldY()==movedPiece.getNewY())) {//comprovar que el moviment)
